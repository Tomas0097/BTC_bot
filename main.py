...
class Bot:
    ...
    def run_trading_session1(self):
        ...
        while True:
            ...
            print(f"{current_time} - Current price - Bought: {'YES' if self.bought_current_position else 'NO'}")
            print(f"{len(self.own_positions)} Own positions: {self.own_positions}")
            print(f"Selled positions: {self.selled_profitable_positions if self.selled_profitable_positions else 'none'}")
    ...
    def buy_position(self, position):
        ...
        self.own_positions.append(self.bought_current_position)
